...
exports.WEPAY = function(settings)
{
    ...
    return {
        ...
        call: function(method, url, params, callbackFunction, riskToken, clientIP) {
            options.path = url;
            ...
            if (settings.client_id){
                options.headers['App-Id'] = settings.client_id;
            }

            if (settings.access_token) {
                options.headers['App-Token'] = settings.access_token;
            }
